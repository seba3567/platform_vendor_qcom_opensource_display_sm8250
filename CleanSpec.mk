...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/bin/hw/android.hardware.graphics.composer@2.3-service)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/etc/init/android.hardware.graphics.composer@2.3-service.rc)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib64/hw/android.hardware.graphics.composer@2.3-impl.so)
...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/lib64/hw/hwcomposer.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/lib/hw/hwcomposer.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/lib64/hw/gralloc.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/lib/hw/gralloc.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/lib64/hw/lights.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/lib/hw/lights.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/lib64/hw/memtrack.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/vendor/lib/hw/memtrack.bengal.so)
...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib64/hw/hwcomposer.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib/hw/hwcomposer.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib64/hw/gralloc.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib/hw/gralloc.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib64/hw/lights.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib/hw/lights.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib64/hw/memtrack.bengal.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib/hw/memtrack.bengal.so)
...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/etc/init/vendor.qti.hardware.display.allocator@1.0-service.rc)

$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib/hw/android.hardware.graphics.mapper@2.0-impl-qti-display.so)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR)/lib64/hw/android.hardware.graphics.mapper@2.0-impl-qti-display.so)
